...
# Create FastAPI app
app = FastAPI(
    title="Company Theme Extraction API",
    description="API for extracting and querying themes from company documents",
    version="1.0.0",
)
...
@app.get("/")
async def root():
    return {"message": "Welcome to the Company Theme Extraction API"}
